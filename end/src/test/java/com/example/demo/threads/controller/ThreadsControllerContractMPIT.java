...
@TestPropertySource(properties = {
        "spring.datasource.url=jdbc:h2:mem:ba_mp;DB_CLOSE_DELAY=-1;MODE=MySQL",
        "spring.datasource.driverClassName=org.h2.Driver",
        "spring.jpa.hibernate.ddl-auto=create-drop",
        "spring.flyway.enabled=false",
        "feature.mp.read.threads=true"
})
public class ThreadsControllerContractMPIT {
    ...
    void list_contract_should_match_and_order_by_createdAt_desc() throws Exception {
        String resp = mockMvc.perform(get("/api/v1/threads").param("page", "1").param("size", "10"))
